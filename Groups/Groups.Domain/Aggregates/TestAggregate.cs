...
namespace Groups.Domain.Aggregates
{
    public class TestAggregate : AggregateRoot
    {
        ...
        private TestAggregate(string name, IEnumerable<QuestionAggregate> questions, 
            GroupAggregate group, bool requirePhoto, int? passedFrom) : base()
        {
            Name = name;
            Questions = questions;
            Group = group;
        ...
        public static TestAggregate Create(string name, IEnumerable<QuestionAggregate> questions, 
            GroupAggregate group, bool requirePhoto = false, int? passedFrom = null)
        {
            var test = new TestAggregate(name, questions, group, requirePhoto, passedFrom);
